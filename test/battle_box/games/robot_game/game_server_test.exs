defmodule BattleBox.Games.RobotGame.GameServerTest do
  ...
  test "the starting of the game server will send init messages to p1 & p2" do
    ...
    expected_p1 = %{expected | player: :player_1}
    expected_p2 = %{expected | player: :player_2}
  ...
  test "you can play a game!" do
    ...
    assert_receive %{game_server: ^pid, player: :player_1}
    assert_receive %{game_server: ^pid, player: :player_2}
